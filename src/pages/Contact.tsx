  ...
  return (
    <Layout>
      ...
      <div className="content-container py-12">
        <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-6">{content.contactTitle}</h1>
        <div className="grid md:grid-cols-2 gap-8">
          <Card>
            <CardContent className="p-6">
              <h2 className="text-xl font-semibold mb-4">{content.contactFormTitle}</h2>
            ...
            <Card>
              <CardContent className="p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">{content.contactLocation}</p>
                </div>
              </CardContent>
            </Card>
          </div>
